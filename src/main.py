...
pizzas = [
    ...
    (2, 'Quarto Formaggi', 190, 'tomato + Mozzarella mozarella + Blue cheese, Parmigiano + Gauda', 'vegetarian'),
    ...
    (6, 'Lorenz', 160, 'Veal sous vide + Chicken sous-vide + Mozzarella cheese + Olives + Champignons + Sweet pepper',
     'classic'),
    (7, 'Nautical', 205, 'Cocktail shrimps + Squid + Mussels + Octopus + Mozzarella cheese + Cream', 'without meet'),
    (8, 'Alpine', 190, 'Smoked chicken + Mozzarella cheese + Champignons + Parsley', 'classic'),
    (9, 'El Toro', 200, 'Veal sous vide + Mozzarella cheese + Champignons + Sun-dried tomatoes + Blue onions',
     'classic'),
